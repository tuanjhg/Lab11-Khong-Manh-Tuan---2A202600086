...
async def run_comparison():
    ...
    Purpose: Demonstrate the effectiveness of the guardrail pipeline
    by comparing attack success rates before and after protection.
    ...
    print("=" * 60)
    _init_judge()  # Initialize the judge for output guardrails
...
class SecurityTestPipeline:
    ...
    async def run_all(self, attacks: list = None) -> list:
        ...
        Purpose: Execute a full security test suite against the agent
        to measure vulnerability of the system.
        ...
        print("=" * 70)
        print("RUNNING SECURITY TEST PIPELINE")
        print("=" * 70)
    ...
    def calculate_metrics(self, results: list) -> dict:
        ...
        Purpose: Summarize the effectiveness of security measures
        by calculating block and leak rates.
